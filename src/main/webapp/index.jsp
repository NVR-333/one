...
<head>
    ...
    <title>NVR Shop - Modern E-Commerce</title>
...
<body>
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="#"><em class="fas fa-mobile-alt"></em> NVR Smartphone</a>
                            <a href="#"><em class="fas fa-laptop"></em> NVR Laptop</a>
                            <a href="#"><em class="fas fa-tshirt"></em> NVR Clothing</a>
                            <a href="#"><em class="fas fa-headphones"></em> NVR Gadget</a>
                            <a href="#"><em class="fas fa-shoe-prints"></em> NVR Footwear</a>
                            <a href="#"><em class="fas fa-watch"></em> NVR Accessorie</a>
                        </div>
                    </li>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>My application for you 2026 byeee </h1>
